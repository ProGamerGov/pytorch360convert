...
class TestFunctionsBaseTest(unittest.TestCase):
    ...
    def test_e2p_exact(self) -> None:
        ...
        a = torch.tensor([[183.03811645507812, 225.49948120117188, 58.833866119384766, 101.29522705078125], [243.3969268798828, 5.628509521484375, 23.704801559448242, 40.9364013671875]])
        b = torch.tensor([[366.07623291015625, 450.99896240234375, 117.66773223876953, 202.5904541015625], [486.7938537597656, 11.25701904296875, 47.409603118896484, 81.872802734375]])
        c = torch.tensor([[732.1524658203125, 901.9979248046875, 235.33546447753906, 405.180908203125], [973.5877075195312, 22.5140380859375, 94.81920623779297, 163.74560546875]])
